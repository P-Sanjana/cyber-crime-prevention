...
String sql="select * from users where st_=1";
...
<td><%=rs.getString("city")%><td><a href="viewc.jsp?email=<%=rs.getString("email")%>" target="_blank">View Chat</a>
<%
}
}
catch(Exception e){
